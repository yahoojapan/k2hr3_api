...
//
export function registerUserTokensTests(): void {
	...
	describe('API : USER TOKEN', function(){
		...
		//
		it('POST /v1/user/tokens : unscoped token by user credential(no tenant) with status 201', function(done){
			request.execute(app)
				.post('/v1/user/tokens')
		...
		it('POST /v1/user/tokens : scoped token by user credential(and tenant) with status 201', function(done){
			request.execute(app)
				.post('/v1/user/tokens')
				.set('content-type', 'application/json')
				.send({
		...
		it('POST /v1/user/tokens : scoped token by unscoped token with status 201', function(done){
			request.execute(app)
				.post('/v1/user/tokens')
				.set('content-type', 'application/json')
		...
		//
		it('POST /v1/user/tokens : failure unscoped token by invalid user credential(no tenant) with status 400', function(done){
			request.execute(app)
				.post('/v1/user/tokens')
				.set('content-type', 'application/json')
				.send({
		...
		it('POST /v1/user/tokens : failure scoped token by invalid user credential(and tenant) with status 400', function(done){
			request.execute(app)
				.post('/v1/user/tokens')
				.set('content-type', 'application/json')
				.send({
		...
		it('POST /v1/user/tokens : failure scoped token by user credential(and invalid tenant) with status 404', function(done){
			request.execute(app)
				.post('/v1/user/tokens')
				.set('content-type', 'application/json')
				.send({
		...
		it('POST /v1/user/tokens : failure scoped token by invalid unscoped token with status 404', function(done){
			request.execute(app)
				.post('/v1/user/tokens')
				.set('content-type', 'application/json')
		...
		it('POST /v1/user/tokens : failure scoped token by invalid tenant name and unscoped token with status 404', function(done){
			request.execute(app)
				.post('/v1/user/tokens')
				.set('content-type', 'application/json')
				.set('x-auth-token', unscopedToken)
		...
		//
		it('PUT /v1/user/tokens : unscoped token by user credential(no tenant) with status 201', function(done){
		...
		it('PUT /v1/user/tokens : scoped token by user credential(and tenant) with status 201', function(done){
			let	url	= '/v1/user/tokens';
		...
		it('PUT /v1/user/tokens : scoped token by unscoped token with status 201', function(done){
			let	url	= '/v1/user/tokens';
			url		+= '?tenantname=tenant0';
			request.execute(app)
				.put(url)
		...
		//
		it('PUT /v1/user/tokens : failure unscoped token by invalid user credential(no tenant) with status 400', function(done){
			let	url	= '/v1/user/tokens';
			url		+= '?tenantname=';
		...
		it('PUT /v1/user/tokens : failure scoped token by invalid user credential(and tenant) with status 400', function(done){
			let	url	= '/v1/user/tokens';
			url		+= '?tenantname=tenant0';
			url		+= '&username=';					// any string for user name is allowed, then set null.
			url		+= '&password=';
		...
		it('PUT /v1/user/tokens : failure scoped token by user credential(and invalid tenant) with status 404', function(done){
			let	url	= '/v1/user/tokens';
		...
		it('PUT /v1/user/tokens : failure scoped token by invalid unscoped token with status 404', function(done){
			let	url	= '/v1/user/tokens';
			url		+= '?tenantname=tenant0';
			request.execute(app)
				.put(url)
		...
		it('PUT /v1/user/tokens : failure scoped token by invalid tenant name and unscoped token with status 404', function(done){
			let	url	= '/v1/user/tokens';
			url		+= '?tenantname=tenantERROR';
			request.execute(app)
				.put(url)
		...
		//
		it('GET /v1/user/tokens : tenant list by unscoped token with status 200', function(done){
			request.execute(app)
				.get('/v1/user/tokens')
				.set('content-type', 'application/json')
				.set('x-auth-token', unscopedToken)
		...
		it('GET /v1/user/tokens : tenant list by scoped token with status 200', function(done){
			request.execute(app)
				.get('/v1/user/tokens')
				.set('content-type', 'application/json')
		...
		//
		it('GET /v1/user/tokens : failure tenant list by invalid unscoped token with status 401', function(done){
			request.execute(app)
				.get('/v1/user/tokens')
				.set('content-type', 'application/json')
				.set('x-auth-token', 'error_dummy_token')
		...
		it('GET /v1/user/tokens : failure tenant list by invalid scoped token with status 401', function(done){
			request.execute(app)
				.get('/v1/user/tokens')
				.set('content-type', 'application/json')
				.set('x-auth-token', 'error_dummy_token')
		...
		//
		it('HEAD /v1/user/tokens : tenant list by unscoped token with status 204', function(done){
			request.execute(app)
				.head('/v1/user/tokens')
				.set('content-type', 'application/json')
				.set('x-auth-token', unscopedToken)
		...
		it('HEAD /v1/user/tokens : tenant list by scoped token with status 204', function(done){
			request.execute(app)
				.head('/v1/user/tokens')
				.set('content-type', 'application/json')
				.set('x-auth-token', scopedToken)
		...
		//
		it('HEAD /v1/user/tokens : failure tenant list by invalid unscoped token with status 401', function(done){
			request.execute(app)
				.head('/v1/user/tokens')
				.set('content-type', 'application/json')
				.set('x-auth-token', 'error_dummy_token')
		...
		it('HEAD /v1/user/tokens : failure tenant list by invalid scoped token with status 401', function(done){
			request.execute(app)
				.head('/v1/user/tokens')
				.set('content-type', 'application/json')
				.set('x-auth-token', 'error_dummy_token')
