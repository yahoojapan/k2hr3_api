...
//
function getV1Version(is_top: boolean): void
{
	const	verpath	= is_top ? '/' : '/v1';
...
// run
//
cliutil.getConsoleInput('path(\'/\' or \'/v1\') : ', true, false, function(isbreak: boolean, path?: string | null): void
{
	if(isbreak){
		process.exit(0);
	}
