...
//
export function registerTenantTests(): void {

	//--------------------------------------------------------------
	// Main describe section
	//--------------------------------------------------------------
	describe('API : TENANT', function(){
		//
		// Common data
		//
		const	alltokens: AllToken = tokenutil.createAllToken();
		let		autotest_post_tenant_0_id: string	= '';
		let		autotest_post_tenant_1_id: string	= '';
		let		autotest_put_tenant_0_id: string	= '';
		let		autotest_put_tenant_1_id: string	= '';
		...
		//
		it('POST /v1/tenant : create tenant(autotest_post_tenant_0) : success 201', function(done){
			request.execute(app)
				.post('/v1/tenant')
				.set('content-type', 'application/json')
				.set('x-auth-token', apiutil.getSafeString(alltokens.unscopedtoken))	// unscoped token
				.send({
					tenant: {
		...
		it('POST /v1/tenant : create tenant(local@autotest_post_tenant_1) with all: success 201', function(done){
			request.execute(app)
				.post('/v1/tenant')
				.set('content-type', 'application/json')
				.set('x-auth-token', apiutil.getSafeString(alltokens.unscopedtoken))	// unscoped token
		...
		it('POST /v1/tenant : create tenant(autotest_post_tenant_0) : failure(exist tenant) 400', function(done){
			request.execute(app)
				.post('/v1/tenant')
				.set('content-type', 'application/json')
				.set('x-auth-token', apiutil.getSafeString(alltokens.unscopedtoken))	// unscoped token
		...
		it('POST /v1/tenant : create tenant(autotest_post_tenant_2) : failure(no token) 400', function(done){
			request.execute(app)
				.post('/v1/tenant')
				.set('content-type', 'application/json')
				.send({
		...
		//
		it('PUT /v1/tenant : create tenant(autotest_put_tenant_0) : success 201', function(done){
			let	uri	= '/v1/tenant';
		...
		it('PUT /v1/tenant : create tenant(local@autotest_put_tenant_1) with all: success 201', function(done){
			let	uri	= '/v1/tenant';
		...
		it('PUT /v1/tenant : create tenant(autotest_put_tenant_0) : failure(exist tenant) 400', function(done){
			let	uri	= '/v1/tenant';
			uri		+= '?name=autotest_put_tenant_0';										// name:	autotest_put_tenant_0
		...
		it('PUT /v1/tenant : create tenant(autotest_put_tenant_2) : failure(no token) 400', function(done){
			let	uri	= '/v1/tenant';
		...
		//
		it('POST /v1/tenant/<tenant> : update tenant(autotest_post_tenant_0) : success 200', function(done){
			request.execute(app)
		...
		it('POST /v1/tenant/<tenant> : update tenant(local@autotest_post_tenant_1) : success 200', function(done){
			request.execute(app)
		...
		it('POST /v1/tenant/<tenant> : update tenant(autotest_post_tenant_3) : failure(not exist tenant) 400', function(done){
			request.execute(app)
		...
		it('POST /v1/tenant/<tenant> : update tenant(autotest_post_tenant_0) : failure(no token) 400', function(done){
			request.execute(app)
				.post('/v1/tenant/autotest_post_tenant_0')
				.set('content-type', 'application/json')
				.send({
		...
		it('POST /v1/tenant/<tenant> : update tenant(autotest_post_tenant_0) : failure(no id) 400', function(done){
			request.execute(app)
				.post('/v1/tenant/autotest_post_tenant_0')
				.set('content-type', 'application/json')
				.set('x-auth-token', apiutil.getSafeString(alltokens.unscopedtoken))	// unscoped token
		...
		//
		it('PUT /v1/tenant/<tenant> : update tenant(autotest_put_tenant_0) : success 200', function(done){
			let	uri	= '/v1/tenant/autotest_put_tenant_0';
		...
		it('PUT /v1/tenant/<tenant> : update tenant(local@autotest_put_tenant_1) : success 200', function(done){
			let	uri	= '/v1/tenant/local@autotest_put_tenant_1';
		...
		it('PUT /v1/tenant/<tenant> : update tenant(autotest_put_tenant_3) : failure(not exist tenant) 400', function(done){
			let	uri	= '/v1/tenant/autotest_put_tenant_3';
		...
		it('PUT /v1/tenant/<tenant> : update tenant(autotest_put_tenant_0) : failure(no token) 400', function(done){
			let	uri	= '/v1/tenant/autotest_put_tenant_0';
			uri		+= '?id=' + autotest_put_tenant_0_id;									// correct id
		...
		it('PUT /v1/tenant/<tenant> : update tenant(autotest_put_tenant_0) : failure(no id) 400', function(done){
			let	uri	= '/v1/tenant/autotest_put_tenant_0';
			uri		+= '?desc=Updated_autotest_put_tenant_0';								// changed
			uri		+= '&display=[UPDATED]autotest_put_tenant_0';							// chnaged
			uri		+= '&users=' + JSON.stringify(['dummyuser']);							// not changed(because there is one user in test data)
		...
		//
		it('GET /v1/tenant : get tenant list and expanding : success 200', function(done){
			request.execute(app)
		...
		it('GET /v1/tenant : get tenant list and no expanding: success 200', function(done){
			request.execute(app)
		...
		it('GET /v1/tenant : get tenant list and expanding : failure(no token) 400', function(done){
			request.execute(app)
				.get('/v1/tenant?expand=true')										// expand:	true
				.set('content-type', 'application/json')
				.end(function(err: Error | null, res: ChaiHttp.Response){
		...
		it('GET /v1/tenant : get tenant list and no expanding: failure(no token) 400', function(done){
			request.execute(app)
				.get('/v1/tenant?expand=false')										// expand:	false
				.set('content-type', 'application/json')
				.end(function(err: Error | null, res: ChaiHttp.Response){
		...
		//
		it('GET /v1/tenant/<tenant> : get tenant(autotest_post_tenant_0) : success 200', function(done){
			request.execute(app)
		...
		it('GET /v1/tenant/<tenant> : get tenant(local@autotest_post_tenant_1) : success 200', function(done){
			request.execute(app)
		...
		it('GET /v1/tenant/<tenant> : get tenant(autotest_post_tenant_0) : failure(no token) 400', function(done){
			request.execute(app)
				.get('/v1/tenant/autotest_post_tenant_0')							// specify tenant name
				.set('content-type', 'application/json')
				.end(function(err: Error | null, res: ChaiHttp.Response){
		...
		it('GET /v1/tenant/<tenant> : get tenant(local@autotest_post_tenant_1) : failure(no token) 400', function(done){
			request.execute(app)
		...
		it('GET /v1/tenant/<tenant> : get tenant(autotest_post_tenant_X) : failure(no tenant) 400', function(done){
			request.execute(app)
		...
		//
		it('HEAD /v1/tenant/<tenant> : head tenant(autotest_post_tenant_0) : success 200', function(done){
			request.execute(app)
		...
		it('HEAD /v1/tenant/<tenant> : head tenant(local@autotest_post_tenant_1) : success 200', function(done){
			request.execute(app)
		...
		it('HEAD /v1/tenant/<tenant> : head tenant(autotest_post_tenant_0) : failure(no token) 400', function(done){
			request.execute(app)
				.head('/v1/tenant/autotest_post_tenant_0')							// specify tenant name
				.set('content-type', 'application/json')
				.end(function(err: Error | null, res: ChaiHttp.Response){
		...
		it('HEAD /v1/tenant/<tenant> : head tenant(local@autotest_post_tenant_1) : failure(no token) 400', function(done){
			request.execute(app)
		...
		it('HEAD /v1/tenant/<tenant> : head tenant(autotest_post_tenant_X) : failure(no tenant) 400', function(done){
			request.execute(app)
		...
		//
		it('DELETE /v1/tenant/<tenant> : delete tenant user(autotest_put_tenant_0) : success 204', function(done){
			let	uri	= '/v1/tenant/autotest_put_tenant_0';							// tenant name
			uri		+= '?id=' + autotest_put_tenant_0_id;							// correct id
		...
		it('DELETE /v1/tenant/<tenant> : delete tenant user(local@autotest_put_tenant_1) : success 204', function(done){
			let	uri	= '/v1/tenant/local@autotest_put_tenant_1';						// tenant name
			uri		+= '?id=' + autotest_put_tenant_1_id;							// correct id
		...
		it('DELETE /v1/tenant/<tenant> : delete tenant user(autotest_post_tenant_0) : failure(no token) 400', function(done){
			let	uri	= '/v1/tenant/autotest_post_tenant_0';							// tenant name
		...
		it('DELETE /v1/tenant/<tenant> : delete tenant user(local@autotest_post_tenant_0) : failure(no token) 400', function(done){
			let	uri	= '/v1/tenant/local@autotest_post_tenant_0';					// tenant name
			uri		+= '?id=' + autotest_post_tenant_0_id;							// correct id
		...
		it('DELETE /v1/tenant/<tenant> : delete tenant user(autotest_post_tenant_X) : failure(no exist tenant) 400', function(done){
			let	uri	= '/v1/tenant/autotest_post_tenant_X';							// not exist tenant name
		...
		//
		it('DELETE /v1/tenant : delete tenant(autotest_post_tenant_0) : failure(no token) 400', function(done){
			let	uri	= '/v1/tenant';
		...
		it('DELETE /v1/tenant : delete tenant(local@autotest_post_tenant_0) : failure(no tenant) 400', function(done){
			let	uri	= '/v1/tenant';
			uri		+= '?id=' + autotest_post_tenant_0_id;							// correct id
		...
		it('DELETE /v1/tenant : delete tenant(local@autotest_post_tenant_0) : failure(no id) 400', function(done){
			let	uri	= '/v1/tenant';
			uri		+= '?tenant=autotest_post_tenant_0';							// tenant name
		...
		it('DELETE /v1/tenant : delete tenant(autotest_post_tenant_X) : failure(no exist tenant) 400', function(done){
			let	uri	= '/v1/tenant';
		...
		it('DELETE /v1/tenant : delete tenant(autotest_post_tenant_X) : failure(wrong id) 400', function(done){
			let	uri	= '/v1/tenant';
			uri		+= '?tenant=autotest_post_tenant_0';							// tenant name
		...
		it('DELETE /v1/tenant : delete tenant(autotest_post_tenant_0) : failure(not local@) 400', function(done){
			let	uri	= '/v1/tenant';
			uri		+= '?tenant=autotest_post_tenant_0';							// tenant name
			uri		+= '&id=' + autotest_post_tenant_0_id;							// correct id
		...
		it('DELETE /v1/tenant/<tenant> : delete tenant(local@autotest_post_tenant_1) : success 204', function(done){
			let	uri	= '/v1/tenant';
