...
//
export function registerAcrTests(): void {

	//--------------------------------------------------------------
	// Main describe section
	//--------------------------------------------------------------
	describe('API : ACR', function(){
		...
		//
		it('GET /v1/acr : failure get user token information for service(not_exist_service) in tenant0 by scoped token with status 403', function(done){
			let	uri	= '/v1/acr';
			...
			request.execute(app)
				...
				.end((err: Error | null, res: ChaiHttp.Response) => {
		...
		it('GET /v1/acr : failure get user token information for service(testservice) in tenant0 by invalid scoped token with status 401', function(done){
			let	uri	= '/v1/acr';
		...
		//
		//	it('GET /v1/acr : failure get user token information for service(testservice) in tenant0 by another scoped token with status 403', function(done){
		//		let	uri	= '/v1/acr';
		//		uri		+= '/testservice';														// path:	yrn:yahoo:testservice::tenant0
		//	
		//		request.execute(app)
		//			.get(uri)
		//			.set('content-type', 'application/json')
		//			.set('x-auth-token', apiutil.getSafeString(alltokens.scopedtoken.tenant2))	// tenant2
		//			.end((err: Error | null, res: ChaiHttp.Response) => {
		//				expect(res).to.have.status(403);
		//				expect(res).to.be.json;
		//				expect(res.body).to.be.an('object');
		...
		it('GET /v1/acr : get user token information for service(testservice) in tenant0 by member scoped token with status 200', function(done){
			let	uri	= '/v1/acr';
			uri		+= '/testservice';														// path:	yrn:yahoo:testservice::tenant0
		...
		it('GET /v1/acr : get user token information for service(testservice) in tenant1 by owner scoped token with status 200', function(done){
			let	uri	= '/v1/acr';
		...
		//
		it('GET /v1/acr : failure get all resource for service(testservice) in tenant0 by not allowed client ip with status 403', function(done){
			let	uri	= '/v1/acr';
			uri		+= '/testservice';														// path:	yrn:yahoo:testservice::tenant0
		...
		it('GET /v1/acr : failure get all resource for service(testservice) in tenant0 without parameter(cip) with status 400', function(done){
			let	uri	= '/v1/acr';
			uri		+= '/testservice';														// path:	yrn:yahoo:testservice::tenant0
			//																				// cip:		not set
			uri		+= '?cport=8000';														// cport:	8000
		...
		it('GET /v1/acr : failure get all resource for service(testservice) in tenant0 without parameter(crole) with status 400', function(done){
			let	uri	= '/v1/acr';
			uri		+= '/testservice';														// path:	yrn:yahoo:testservice::tenant0
		...
		it('GET /v1/acr : failure get all resource for service(testservice) in tenant0 without parameter(srole) with status 400', function(done){
			let	uri	= '/v1/acr';
			uri		+= '/testservice';														// path:	yrn:yahoo:testservice::tenant0
			uri		+= '?cip=127.1.0.1';													// cip:		127.1.0.1
			uri		+= '&cport=8000';														// cport:	8000
		...
		it('GET /v1/acr : get all resource for service(testservice) in tenant0 with status 200', function(done){
			let	uri	= '/v1/acr';
			uri		+= '/testservice';														// path:	yrn:yahoo:testservice::tenant0
			uri		+= '?cip=127.1.0.1';													// cip:		127.1.0.1
			uri		+= '&cport=8000';														// cport:	8000
		...
		it('GET /v1/acr : get all resource for service(testservice) in tenant0 without parameter(cport,ccuk) with status 200', function(done){
			let	uri	= '/v1/acr';
			uri		+= '/testservice';														// path:	yrn:yahoo:testservice::tenant0
			uri		+= '?cip=127.1.0.1';													// cip:		127.1.0.1
			//																				// cport:	not set
		...
		it('GET /v1/acr : get all resource for service(testservice) in tenant0 without parameter(sport,scuk) with status 200', function(done){
			let	uri	= '/v1/acr';
			uri		+= '/testservice';														// path:	yrn:yahoo:testservice::tenant0
			uri		+= '?cip=127.1.0.1';													// cip:		127.1.0.1
			uri		+= '&cport=8000';														// cport:	8000
		...
		//
		it('DELETE /v1/acr : delete not exist service(not_exist_service) in tenant0 by scoped token with status 204', function(done){
			let	uri	= '/v1/acr';
			uri		+= '/not_exist_service';												// path:	yrn:yahoo:not_exist_service::tenant0
		...
		it('DELETE /v1/acr : delete service(testservice) in tenant0 by another tenant scoped token with status 204', function(done){
			let	uri	= '/v1/acr';
			uri		+= '/testservice';														// path:	yrn:yahoo:testservice::tenant0
		...
		it('DELETE /v1/acr : delete service(testservice) in tenant0 by invalid scoped token with status 204', function(done){
			let	uri	= '/v1/acr';
			uri		+= '/testservice';														// path:	yrn:yahoo:testservice::tenant0
		...
		it('DELETE /v1/acr : delete service(testservice) in tenant0 by scoped token with status 204', function(done){
			let	uri	= '/v1/acr';
			uri		+= '/testservice';														// path:	yrn:yahoo:testservice::tenant0
		...
		//
		it('(SERVICE POST FOR ACR TEST) /v1/service : create new service(acr_test_service) in tenant1 by scoped token with status 201', function(done){
			//
		...
		it('POST /v1/acr : failure create service(acr_test_service) in tenant0 by invalid scoped token with status 401', function(done){
			let	uri	= '/v1/acr';
		...
		it('POST /v1/acr : failure create service(not_exist_service) in tenant0 by scoped token with status 403', function(done){
			let	uri	= '/v1/acr';
			uri		+= '/not_exist_service';												// path:	yrn:yahoo:not_exist_service::tenant0
		...
		it('POST /v1/acr : create service(acr_test_service) in tenant0 by scoped token with status 201', function(done){
			let	uri	= '/v1/acr';
			uri		+= '/acr_test_service';													// path:	yrn:yahoo:acr_test_service::tenant0
		...
		it('POST /v1/acr : failure create service(acr_test_service) in tenant0 by invalid unscoped scoped token with status 401', function(done){
			let	uri	= '/v1/acr';
			uri		+= '/acr_test_service';													// path:	yrn:yahoo:acr_test_service::tenant0
		...
		it('POST /v1/acr : failure create service(not_exist_service) in tenant0 by unscoped scoped token with status 403', function(done){
			let	uri	= '/v1/acr';
			uri		+= '/not_exist_service';												// path:	yrn:yahoo:not_exist_service::tenant0
			...
			request.execute(app)
				.post(uri)
				.set('content-type', 'application/json')
				.set('x-auth-token', apiutil.getSafeString(alltokens.unscopedtoken))		// unscoped user token
				.send({																		// tenant0
					tenant:	'tenant0'
				})
				.end(function(err: Error | null, res: ChaiHttp.Response){
		...
		it('POST /v1/acr : failure create service(acr_test_service) in invalid tenant by unscoped scoped token with status 400', function(done){
			let	uri	= '/v1/acr';
		...
		it('POST /v1/acr : create service(acr_test_service) in tenant0 by unscoped scoped token with status 201', function(done){
			let	uri	= '/v1/acr';
			uri		+= '/acr_test_service';													// path:	yrn:yahoo:acr_test_service::tenant0
		...
		it('POST /v1/acr : create service(testservice) in tenant0 by scoped token with status 200(but error 401/403 in mocha)', function(done){
			let	uri	= '/v1/acr';
			uri		+= '/testservice';														// path:	yrn:yahoo:testservice::tenant0
			...
			request.execute(app)
				...
				.end(function(err: Error | null, res: ChaiHttp.Response){
					...
					//
					expect(res.status).to.satisfy(function(status: number){
					...
					expect(res.body.message).to.satisfy(function(message: string){
		...
		//
		it('PUT /v1/acr : failure create service(acr_test_service) in tenant0 by invalid scoped token with status 401', function(done){
			let	uri	= '/v1/acr';
			uri		+= '/acr_test_service';													// path:	yrn:yahoo:acr_test_service::tenant0
		...
		it('PUT /v1/acr : failure create service(not_exist_service) in tenant0 by scoped token with status 403', function(done){
			let	uri	= '/v1/acr';
			uri		+= '/not_exist_service';												// path:	yrn:yahoo:not_exist_service::tenant0
		...
		it('PUT /v1/acr : create service(acr_test_service) in tenant0 by scoped token with status 201', function(done){
			let	uri	= '/v1/acr';
			uri		+= '/acr_test_service';													// path:	yrn:yahoo:acr_test_service::tenant0
		...
		it('PUT /v1/acr : failure create service(acr_test_service) in tenant0 by invalid unscoped scoped token with status 401', function(done){
			let	uri	= '/v1/acr';
			uri		+= '/acr_test_service';													// path:	yrn:yahoo:acr_test_service::tenant0
		...
		it('PUT /v1/acr : failure create service(not_exist_service) in tenant0 by unscoped scoped token with status 403', function(done){
			let	uri	= '/v1/acr';
			uri		+= '/not_exist_service';												// path:	yrn:yahoo:not_exist_service::tenant0
			uri		+= '?tenant=tenant0';													// tenant0
		...
		it('PUT /v1/acr : failure create service(acr_test_service) in invalid tenant by unscoped scoped token with status 400', function(done){
			let	uri	= '/v1/acr';
			uri		+= '/acr_test_service';													// path:	yrn:yahoo:acr_test_service::invalid_tenant
		...
		it('PUT /v1/acr : create service(acr_test_service) in tenant0 by unscoped scoped token with status 201', function(done){
			let	uri	= '/v1/acr';
			uri		+= '/acr_test_service';													// path:	yrn:yahoo:acr_test_service::tenant0
			uri		+= '?tenant=tenant0';													// tenant0
		...
		it('PUT /v1/acr : create service(testservice) in tenant0 by scoped token with status 200(but error 401/403 in mocha)', function(done){
			let	uri	= '/v1/acr';
			uri		+= '/testservice';														// path:	yrn:yahoo:testservice::tenant0
