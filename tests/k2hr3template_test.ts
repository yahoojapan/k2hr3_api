...
import	{ isValTypeTemplateVariablesMap, isK2hr3TemplateResult, type valTypeTemplateVariablesMap }	from '../src/lib/k2hr3template';
...
// execute main
//
function execTemplateEngine(templString: string, varmap: valTypeTemplateVariablesMap): boolean
{
	...
	const vars = r3templ.getVariableNames();
	console.log('----------------------------------------------------------------');
	...
	const resobj = r3templ.execute(varmap);
	console.log('----------------------------------------------------------------');
	console.log('RESULT');
	console.log('----------------------------------------------------------------');
